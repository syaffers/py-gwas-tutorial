...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$k2u9IcIcXaGTJEZEq/8Buw$idhrjRoKlooRGnT+NxhZLkotA4i7d9VyEatxJJJmO+M'
...
#  Choices: any of ['sha3_512', 'sha256', 'sha3_384', 'blake2b', 'sha224', 'sha3_256', 'sha384', 'sha3_224', 'sha1', 'md5', 'sha512', 'blake2s']
#  Default: 'sha256'
